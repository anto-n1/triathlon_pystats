...
\includegraphics[width=0.9\linewidth, height=7cm]{graphs/repartition_temps.png} 
\caption{Caption1}
\label{fig:subim1}
\end{subfigure}
\begin{subfigure}{0.5\textwidth}
\includegraphics[width=0.9\linewidth, height=6cm]{graphs/repartition_distance.png}
%\caption{Caption 2}
\label{fig:subim2}
\end{subfigure}
...
\begin{figure}
     ...
     \begin{subfigure}[b]{0.3\textwidth}
         \centering
         \includegraphics[width=\textwidth]{graphs/repartition_temps.png}
         \caption{$y=x$}
     ...
     \begin{subfigure}[b]{0.3\textwidth}
         \centering
         \includegraphics[width=\textwidth]{graphs/repartition_distance.png}
         \caption{$y=3sinx$}
